...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "cosmic-gradient":
          "linear-gradient(135deg, hsl(var(--background)) 0%, hsl(var(--cosmic)) 50%, hsl(var(--mystic)) 100%)",
        "stellar-gradient":
          "linear-gradient(45deg, hsl(var(--stellar)) 0%, hsl(var(--cosmic)) 50%, hsl(var(--mystic)) 100%)",
        "golden-gradient":
          "linear-gradient(135deg, hsl(var(--golden)) 0%, #f59e0b 50%, #d97706 100%)",
      },
    },
  },
